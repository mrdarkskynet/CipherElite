...
def handle_zip_file(downloaded_file_content, file_name_zip, message):
    ...
    try:
        ...
        # ✅ FIX: Skip pip install from uploaded zip
        ...
        # ✅ FIX: Skip npm install from uploaded zip
                ...
                if os.path.exists(file_path):
                    ...
                    try:
                        if file_type == 'py':
                            ...
                            logger.warning(f"Unknown file type '{file_type}' for {file_name}. Skipping.")
...
def start_bot_callback(call):
    try:
        ...
        if file_type == 'py':
            ...
            bot.send_message(chat_id_for_reply, f"❌ Unknown file type '{file_type}'.")
            return
